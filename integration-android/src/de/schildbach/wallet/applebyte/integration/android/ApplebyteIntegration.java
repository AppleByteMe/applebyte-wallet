...
package de.schildbach.wallet.applebyte.integration.android;
 ...
 */
public final class ApplebyteIntegration
{
	private static final String INTENT_EXTRA_TRANSACTION_HASH = "transaction_hash";

	/**
	 * Request any amount of Applebytes (probably a donation) from user, without feedback from the app.
	 * 
	 * @param context
	 *            Android context
	 * @param address
	...
	/**
	 * Request specific amount of Applebytes from user, without feedback from the app.
	 * 
	 * @param context
	 *            Android context
	 * @param address
	...
	/**
	 * Request any amount of Applebytes (probably a donation) from user, with feedback from the app. Result intent can be
	 ...
	 * 
	 * Warning: A success indication is no guarantee! To be on the safe side, you must drive your own Applebyte
	...
	/**
	 * Request specific amount of Applebytes from user, with feedback from the app. Result intent can be received by
	...
	/**
	 * Put transaction hash into result intent. Meant for usage by Applebyte wallet applications.
	 * 
	 * @param result
	 *            result intent
	 * @param txHash
	...
	/**
	 * Get transaction hash from result intent. Meant for usage by applications initiating a Applebyte payment.
	 * 
	 * You can use this hash to request the transaction from the Applebyte network, in order to validate. For this, you
	 * need your own Applebyte infrastructure though. There is no guarantee that the transaction has ever been broadcasted
	 * to the Applebyte network.
	 * 
	 * @param result
	 *            result intent
	...
	{
		final StringBuilder uri = new StringBuilder("applebyte:");
		if (address != null)
			uri.append(address);
		if (amount != null)
