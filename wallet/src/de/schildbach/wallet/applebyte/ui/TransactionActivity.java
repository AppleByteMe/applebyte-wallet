...
import com.google.applebyte.core.ProtocolException;
import com.google.applebyte.core.Sha256Hash;
import com.google.applebyte.core.Transaction;
import com.google.applebyte.core.VerificationException;
...
public final class TransactionActivity extends AbstractWalletActivity
{
	...
	private void handleIntent(final Intent intent)
	{
		...
		else if (intentUri != null && "abytx".equals(scheme))
		{
			try
			{
	...
	private void updateView()
	{
		...
		if (nfcManager != null)
			NfcTools.publishMimeObject(nfcManager, this, Constants.MIMETYPE_TRANSACTION, tx.unsafeApplebyteSerialize(), false);
	}
