...
import com.google.applebyte.core.VersionMessage;
...
public final class AboutActivity extends SherlockPreferenceActivity
{
	...
	private static final String KEY_ABOUT_CREDITS_APPLEBYTEJ = "about_credits_applebytej";
	...
	protected void onCreate(final Bundle savedInstanceState)
	{
		...
		findPreference(KEY_ABOUT_CREDITS_APPLEBYTEJ).setTitle(getString(R.string.about_credits_applebytej_title, VersionMessage.APPLEBYTEJ_VERSION));
		findPreference(KEY_ABOUT_CREDITS_APPLEBYTEJ).setSummary(Constants.CREDITS_APPLEBYTEJ_URL);
	...
	public boolean onPreferenceTreeClick(final PreferenceScreen preferenceScreen, final Preference preference)
	{
		...
		else if (KEY_ABOUT_CREDITS_APPLEBYTEJ.equals(key))
		{
			startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(Constants.CREDITS_APPLEBYTEJ_URL)));
			finish();
		}
