...
public final class SendCoinsActivity extends AbstractWalletActivity
{
	...
	private void handleIntent(final Intent intent)
	{
		...
		if ((Intent.ACTION_VIEW.equals(action) || NfcAdapter.ACTION_NDEF_DISCOVERED.equals(action)) && intentUri != null && "applebyte".equals(scheme))
		{
			try
			{
				final ApplebyteURI applebyteUri = new ApplebyteURI(null, intentUri.toString());
				address = applebyteUri.getAddress().toString();
				addressLabel = applebyteUri.getLabel();
				amount = applebyteUri.getAmount();
			}
