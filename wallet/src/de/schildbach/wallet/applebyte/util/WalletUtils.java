...
import com.google.applebyte.core.DumpedPrivateKey;
import com.google.applebyte.core.ECKey;
...
import com.google.applebyte.core.TransactionInput;
import com.google.applebyte.core.TransactionOutput;
...
public class WalletUtils
{
	...
	public static BigInteger localValue(final BigInteger abyValue, final BigInteger rate)
	{
		return abyValue.multiply(rate).divide(Utils.COIN);
	}

	public static BigInteger abyValue(final BigInteger localValue, final BigInteger rate)
	{
	...
	public static void writeKeys(final Writer out, final List<ECKey> keys) throws IOException
	{
		...
		out.write("# KEEP YOUR PRIVATE KEYS SAFE! Anyone who can read this can spend your Applebytes.\n");
